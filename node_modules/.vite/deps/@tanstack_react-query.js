import {
  require_jsx_runtime
} from "./chunk-F32QSB3J.js";
import {
  require_react
} from "./chunk-HPDSNDDJ.js";
import {
  __privateAdd,
  __privateGet,
  __privateMethod,
...
var QueryClientProvider = ({ client, children }) => {
  ...
  return (0, import_jsx_runtime.jsx)(QueryClientContext.Provider, {
    value: client,
    children
  });
};
...
var TimeoutManager = (_a = class {
  ...
  */
  setTimeoutProvider(provider) {
    if (true) {
      if (__privateGet(this, _providerCalled) && provider !== __privateGet(this, _provider)) console.error(`[timeoutManager]: Switching provider after calls to previous provider might result in unexpected behavior.`, {
        previous: __privateGet(this, _provider),
        provider
      });
    }
    __privateSet(this, _provider, provider);
    if (true) __privateSet(this, _providerCalled, false);
  }
  /**
  ...
  */
  setTimeout(callback, delay) {
    if (true) __privateSet(this, _providerCalled, true);
...
function tryResolveSync(promise) {
  var _a13, _b;
  let data;
  (_b = (_a13 = promise.then((result) => {
    data = result;
    return result;
  }, noop)) == null ? void 0 : _a13.catch) == null ? void 0 : _b.call(_a13, noop);
...
function dehydratePromise(query, serializeData, shouldRedactErrors) {
  ...
  const promise = (_a13 = query.promise) == null ? void 0 : _a13.then(serializeData).catch((error) => {
    if ((shouldRedactErrors == null ? void 0 : shouldRedactErrors(error)) === false) return Promise.reject(error);
    if (true) console.error(`A query that was dehydrated as pending ended up rejecting. [${query.queryHash}]: ${error}; The error will be redacted in production builds`);
...
function dehydrate(client, options = {}) {
  ...
  const shouldRedactErrors = options.shouldRedactErrors ?? ((_c = client.getDefaultOptions().dehydrate) == null ? void 0 : _c.shouldRedactErrors);
  const serializeData = options.serializeData ?? ((_d = client.getDefaultOptions().dehydrate) == null ? void 0 : _d.serializeData);
  return {
    mutations,
...
function hydrate(client, dehydratedState, options) {
  ...
  const deserializeData = ((_a13 = options == null ? void 0 : options.defaultOptions) == null ? void 0 : _a13.deserializeData) ?? ((_b = client.getDefaultOptions().hydrate) == null ? void 0 : _b.deserializeData);
  (_c = dehydratedState.mutations) == null ? void 0 : _c.forEach(({ state, ...mutationOptions2 }) => {
    var _a14, _b2;
  ...
  (_d = dehydratedState.queries) == null ? void 0 : _d.forEach(({ queryKey, state, queryHash, meta, promise, dehydratedAt, queryType }) => {
    var _a14, _b2;
...
function createRetryer(config) {
  ...
  const pause = () => {
    return new Promise((continueResolve) => {
      ...
      var _a13;
      continueFn = void 0;
      if (!isResolved()) (_a13 = config.onContinue) == null ? void 0 : _a13.call(config);
    });
  };
  const run = () => {
...
function infiniteQueryBehavior(pages) {
  return { onFetch: (context, query) => {
    ...
    if (context.options.persister) context.fetchFn = () => {
      var _a14, _b2;
      return (_b2 = (_a14 = context.options).persister) == null ? void 0 : _b2.call(_a14, fetchFn, {
        client: context.client,
        queryKey: context.queryKey,
        meta: context.options.meta,
...
var _queryType, _initialState, _revertState, _cache, _client, _retryer, _defaultOptions, _abortSignalConsumed, _Query_instances, dispatch_fn, _a5;
var Query = (_a5 = class extends Removable {
  ...
  */
  ...
  onFocus() {
    var _a13, _b;
    (_a13 = this.observers.find((x) => x.shouldFetchOnWindowFocus())) == null ? void 0 : _a13.refetch({ cancelRefetch: false });
    (_b = __privateGet(this, _retryer)) == null ? void 0 : _b.continue();
  }
  /** @internal */
  onOnline() {
    var _a13, _b;
    (_a13 = this.observers.find((x) => x.shouldFetchOnReconnect())) == null ? void 0 : _a13.refetch({ cancelRefetch: false });
    (_b = __privateGet(this, _retryer)) == null ? void 0 : _b.continue();
  }
  /** @internal */
  ...
  */
  async fetch(options, fetchOptions) {
    ...
    if (this.state.fetchStatus !== "idle" && ((_a13 = __privateGet(this, _retryer)) == null ? void 0 : _a13.status()) !== "rejected") {
    ...
    (_b = __privateGet(this, _queryType) === "infinite" ? infiniteQueryBehavior(this.options.pages) : this.options.behavior) == null ? void 0 : _b.onFetch(context, this);
    __privateSet(this, _revertState, this.state);
    if (this.state.fetchStatus === "idle" || this.state.fetchMeta !== ((_c = context.fetchOptions) == null ? void 0 : _c.meta)) __privateMethod(this, _Query_instances, dispatch_fn).call(this, {
      type: "fetch",
      meta: (_d = context.fetchOptions) == null ? void 0 : _d.meta
    });
    ...
    try {
      ...
      (_h = (_g = __privateGet(this, _cache).config).onSettled) == null ? void 0 : _h.call(_g, data, this.state.error, this);
      return data;
    } catch (error) {
      ...
      (_j = (_i = __privateGet(this, _cache).config).onError) == null ? void 0 : _j.call(_i, error, this);
      (_l = (_k = __privateGet(this, _cache).config).onSettled) == null ? void 0 : _l.call(_k, this.state.data, error, this);
      throw error;
    } finally {
...
var _client2, _currentQuery, _currentQueryInitialState, _currentResult, _currentResultState, _currentResultOptions, _selectError, _selectFn, _selectResult, _lastQueryWithDefinedData, _staleTimeoutId, _refetchIntervalId, _currentRefetchInterval, _trackedProps, _QueryObserver_instances, executeFetch_fn, shouldScheduleTimer_fn, updateStaleTimeout_fn, computeRefetchInterval_fn, updateRefetchInterval_fn, updateTimers_fn, clearStaleTimeout_fn, clearRefetchInterval_fn, updateQuery_fn, _a6;
var QueryObserver = (_a6 = class extends Subscribable {
  ...
  createResult(query, options) {
    ...
    if (options.placeholderData !== void 0 && data === void 0 && status === "pending") {
      ...
      if ((prevResult == null ? void 0 : prevResult.isPlaceholderData) && options.placeholderData === (prevResultOptions == null ? void 0 : prevResultOptions.placeholderData)) {
        ...
        skipSelect = true;
      } else placeholderData = typeof options.placeholderData === "function" ? options.placeholderData((_a13 = __privateGet(this, _lastQueryWithDefinedData)) == null ? void 0 : _a13.state.data, __privateGet(this, _lastQueryWithDefinedData)) : options.placeholderData;
  ...
  */
  ...
  return !isServer2() && resolveQueryValue(this.options.enabled, __privateGet(this, _currentQuery)) !== false && isValidTimeout(timeout);
...
var Mutation = (_a7 = class extends Removable {
  ...
  */
  continue() {
    var _a13;
    return ((_a13 = __privateGet(this, _retryer2)) == null ? void 0 : _a13.continue()) ?? (this.state.status === "pending" ? this.execute(this.state.variables) : Promise.resolve());
  }
  /**
  ...
  async execute(variables) {
    ...
    try {
      if (restored) onContinue();
        ...
        const context = await ((_b = (_a13 = this.options).onMutate) == null ? void 0 : _b.call(_a13, variables, mutationFnContext));
      ...
      const data = await retryer.start();
      await ((_d = (_c = __privateGet(this, _mutationCache).config).onSuccess) == null ? void 0 : _d.call(_c, data, variables, this.state.context, this, mutationFnContext));
      await ((_f = (_e = this.options).onSuccess) == null ? void 0 : _f.call(_e, data, variables, this.state.context, mutationFnContext));
      await ((_h = (_g = __privateGet(this, _mutationCache).config).onSettled) == null ? void 0 : _h.call(_g, data, null, this.state.variables, this.state.context, this, mutationFnContext));
      ...
      try {
        await ((_l = (_k = __privateGet(this, _mutationCache).config).onError) == null ? void 0 : _l.call(_k, error, variables, this.state.context, this, mutationFnContext));
      } catch (e) {
        Promise.reject(e);
      }
      try {
...
var MutationCache = (_a8 = class extends Subscribable {
  ...
  canRun(mutation) {
    ...
    const scope = scopeFor(mutation);
    if (typeof scope === "string") {
      const firstPendingMutation = (_a13 = __privateGet(this, _scopes).get(scope)) == null ? void 0 : _a13.find((m) => m.state.status === "pending");
  ...
  runNext(mutation) {
    var _a13, _b;
    const scope = scopeFor(mutation);
    if (typeof scope === "string") return ((_b = (_a13 = __privateGet(this, _scopes).get(scope)) == null ? void 0 : _a13.find((m) => m !== mutation && m.state.isPaused)) == null ? void 0 : _b.continue()) ?? Promise.resolve();
...
var _client4, _currentResult2, _currentMutation, _mutateOptions, _MutationObserver_instances, updateResult_fn, notify_fn, _a9;
var MutationObserver = (_a9 = class extends Subscribable {
  ...
  */
  setOptions(options) {
    ...
    else if (((_a13 = __privateGet(this, _currentMutation)) == null ? void 0 : _a13.state.status) === "pending") __privateGet(this, _currentMutation).setOptions(this.options);
  }
  onSubscribe() {
  ...
  onUnsubscribe() {
    var _a13;
    if (!this.hasListeners()) (_a13 = __privateGet(this, _currentMutation)) == null ? void 0 : _a13.removeObserver(this);
  }
  /** @internal */
  ...
  notifyManager.batch(() => {
    ...
    if (__privateGet(this, _mutateOptions) && this.hasListeners()) {
      ...
      if ((action == null ? void 0 : action.type) === "success") {
        try {
          (_b = (_a13 = __privateGet(this, _mutateOptions)).onSuccess) == null ? void 0 : _b.call(_a13, action.data, variables, onMutateResult, context);
        } catch (e) {
          Promise.reject(e);
        }
        try {
          (_d = (_c = __privateGet(this, _mutateOptions)).onSettled) == null ? void 0 : _d.call(_c, action.data, null, variables, onMutateResult, context);
        } catch (e) {
          Promise.reject(e);
        }
      } else if ((action == null ? void 0 : action.type) === "error") {
        try {
          (_f = (_e = __privateGet(this, _mutateOptions)).onError) == null ? void 0 : _f.call(_e, action.error, variables, onMutateResult, context);
        } catch (e) {
          Promise.reject(e);
        }
        try {
          (_h = (_g = __privateGet(this, _mutateOptions)).onSettled) == null ? void 0 : _h.call(_g, void 0, action.error, variables, onMutateResult, context);
        } catch (e) {
          Promise.reject(e);
        }
      }
...
var _client5, _result, _queries, _options, _observers2, _combinedResult, _lastCombine, _lastResult, _lastQueryHashes, _observerMatches, _QueriesObserver_instances, trackResult_fn, combineResult_fn, shouldSkipCombine_fn, findMatchingObservers_fn, onUpdate_fn, notify_fn2, _a10;
var QueriesObserver = (_a10 = class extends Subscribable {
  ...
  onSubscribe() {
    if (this.listeners.size === 1) __privateGet(this, _observers2).forEach((observer) => {
  ...
  */
  setQueries(queries, options) {
    ...
    __privateSet(this, _options, options);
    if (true) {
      const queryHashes = queries.map((query) => __privateGet(this, _client5).defaultQueryOptions(query).queryHash);
  ...
  */
  ...
  if (combine) {
    ...
    if (__privateGet(this, _result) !== __privateGet(this, _lastResult) || queryHashesChanged || combine !== __privateGet(this, _lastCombine)) {
      __privateSet(this, _lastCombine, combine);
      __privateSet(this, _lastResult, __privateGet(this, _result));
      if (queryHashes !== void 0) __privateSet(this, _lastQueryHashes, queryHashes);
  ...
  var _a13;
  return !((_a13 = __privateGet(this, _options)) == null ? void 0 : _a13.combine) || __privateGet(this, _observers2).some((observer, index) => {
    var _a14;
  ...
  queries.forEach((options) => {
    ...
    const observer = ((_a13 = prevObserversMap.get(defaultedOptions.queryHash)) == null ? void 0 : _a13.shift()) ?? new QueryObserver(__privateGet(this, _client5), defaultedOptions);
    observers.push({
  ...
  if (index !== -1) {
    __privateSet(this, _result, __privateGet(this, _result).slice());
    __privateGet(this, _result)[index] = result;
    __privateMethod(this, _QueriesObserver_instances, notify_fn2).call(this);
  }
}, notify_fn2 = function() {
  var _a13;
  if (this.hasListeners()) {
    ...
    const newResult = shouldSkipCombine ? previousResult : __privateMethod(this, _QueriesObserver_instances, combineResult_fn).call(this, __privateMethod(this, _QueriesObserver_instances, trackResult_fn).call(this, __privateGet(this, _result), __privateGet(this, _observerMatches)), (_a13 = __privateGet(this, _options)) == null ? void 0 : _a13.combine);
...
var QueryCache = (_a11 = class extends Subscribable {
  ...
  */
  remove(query) {
    if (__privateGet(this, _queries2).get(query.queryHash) === query) {
      query.destroy();
...
var QueryClient = (_a12 = class {
  ...
  */
  setQueryData(queryKey, updater, options) {
    ...
    const prevData = (_a13 = __privateGet(this, _queryCache).get(defaultedOptions.queryHash)) == null ? void 0 : _a13.state.data;
  ...
  */
  getQueryState(queryKey) {
    var _a13;
    const options = this.defaultQueryOptions({ queryKey });
    return (_a13 = __privateGet(this, _queryCache).get(options.queryHash)) == null ? void 0 : _a13.state;
  }
  /**
...
var dataTagSymbol = Symbol();
var dataTagErrorSymbol = Symbol();
...
var QueryErrorResetBoundary = ({ children }) => {
  const [value] = React4.useState(() => createValue());
  return (0, import_jsx_runtime2.jsx)(QueryErrorResetBoundaryContext.Provider, {
    value,
...
function useQueries({ queries, ...options }, queryClient) {
  ...
  const defaultedQueries = React6.useMemo(() => queries.map((opts) => {
  ...
  const [observer] = React6.useState(() => new QueriesObserver(client, defaultedQueries, options));
  ...
  React6.useSyncExternalStore(React6.useCallback((onStoreChange) => shouldSubscribe ? observer.subscribe(notifyManager.batchCalls(onStoreChange)) : noop, [observer, shouldSubscribe]), () => observer.getCurrentResult(), () => observer.getCurrentResult());
  React6.useEffect(() => {
...
function useBaseQuery(options, Observer, queryClient) {
  ...
  useClearResetErrorBoundary(errorResetBoundary);
  const [observer] = React7.useState(() => new Observer(client, defaultedOptions));
...
function useIsFetching(filters, queryClient) {
  const client = useQueryClient(queryClient);
  const queryCache = client.getQueryCache();
  return React8.useSyncExternalStore(React8.useCallback((onStoreChange) => queryCache.subscribe(notifyManager.batchCalls(onStoreChange)), [queryCache]), () => client.isFetching(filters), () => client.isFetching(filters));
}
...
function useMutationState(options = {}, queryClient) {
  ...
  return React9.useSyncExternalStore(React9.useCallback((onStoreChange) => mutationCache.subscribe(() => {
...
function useMutation(options, queryClient) {
  const client = useQueryClient(queryClient);
  const [observer] = React10.useState(() => new MutationObserver(client, options));
  React10.useEffect(() => {
    observer.setOptions(options);
  }, [observer, options]);
  const result = React10.useSyncExternalStore(React10.useCallback((onStoreChange) => observer.subscribe(notifyManager.batchCalls(onStoreChange)), [observer]), () => observer.getCurrentResult(), () => observer.getCurrentResult());
  const mutate = React10.useCallback((...args) => {
