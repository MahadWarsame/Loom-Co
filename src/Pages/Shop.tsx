...
export function Shop() {
  const [params,setParams]=useSearchParams(); const categorySlug=params.get("cat")??undefined;
  const [color,setColor]=useState<string|undefined>(); const [material,setMaterial]=useState<string|undefined>();
  const {data:categories}=useCategories(); const {data:products,isLoading}=useProducts({categorySlug,color,material});
